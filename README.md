...
### 로그인 및 그룹 목록
- 카카오로 서비스에 로그인할 수 있습니다. 첫 모임 목록 페이지에서 새 그룹 만들기 버튼을 눌러 새로운 그룹을 생성할 수 있습니다.
- 그룹원의 경우 서비스에 가입된 카카오 친구들을 초대할 수 있습니다. 친구피커에서 초대할 인원을 선택 후 모임 생성하기 버튼을 누르면 새 모임이 만들어지고 초대한 친구들에게는 초대 메시지가 전송됩니다.
...
### 영수증 촬영하여 지출 등록
- 영수증을 찍는것 만으로 일일히 입력할 필요 없이 간편하게 지출을 등록할 수 있습니다.
