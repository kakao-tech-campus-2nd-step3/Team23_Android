...
class ExpenseDetailItemListAdapter(
    ...
    ListAdapter<ExpenseDetailItem, ExpenseDetailItemListAdapter.ExpenseDetailItemViewHolder>(object :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExpenseDetailItemViewHolder {
        ...
        viewHolderBinding.itemCallback = object : ExpenseDetailItemCallback {
